...
export declare class EventService {
    ...
    getAllEvents(limit?: number): Promise<any[] | import("nestjs-dynamoose").QueryResponse<any>>;
    updateEvent(eventKey: EventKey, body: any): Promise<any>;
    ...
    getEventAvailable(currentTime: number): Promise<import("nestjs-dynamoose").ScanResponse<any>>;
    ...
    getDataByTime(startTime: number, endTime: number): Promise<import("nestjs-dynamoose").ScanResponse<any>>;
}
